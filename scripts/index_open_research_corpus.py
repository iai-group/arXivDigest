...
if __name__ == '__main__':
    ...
    parser.add_argument("--path", type=Path, help="path to directory containing the dataset (.gz files)",
    ...
    for success, info in parallel_bulk(es, gen_corpus(args.index, args.path)):
        if not success:
